	...
	<div class="trip_main_footer">
		<div class="main_footer trip_main_footer_line">
			<div class="trip_main_footer_inner">
				<div class="main_footer_cnt trip_main_foot_clearfix">
					...
					<div class="main_footer_block">
						...
						<ul class="foot_clearfix_list_2">
							...
							<li><a target="">채용</a></li>
							<li><a target="">이용약관</a></li>
							<li><a target="">개인정보 처리방침</a></li>
							<li><a target="">about Trip.com Group</a></li>
						</ul>
					</div>
					...
					<div class="main_footer_block">
						...
						<ul class="foot_clearfix_list_3">
							...
							<li><a target="">트립닷컴 파트너제휴 플랫폼</a></li>
							<li><a target="">호텔 등록</a></li>
							<li><a target="">모든 호텔</a></li>
				...
				<hr>
				<div class="trip_main_foot_rights">
					<div class="foot_right_text">
						Copyright © 2021 Trip.com Travel Singapore Pte. Ltd. All rights
						reserved. <br> 사이트 운영자: Trip.com Travel Singapore Pte. Ltd.
						(라이선스 번호 02943, 대표 오이치통) <br> 1 Harbourfront Ave, #03-12/13,
						Keppel Bay Tower, Singapore (098632) <br> 고객센터: 한국 1666 0060
						해외 +86 513 8918 6111
					</div>
				</div>
			</div>
